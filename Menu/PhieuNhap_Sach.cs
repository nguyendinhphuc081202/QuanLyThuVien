...
namespace Menu
{
    public partial class PhieuNhap_Sach : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Tồn tại nhiều mã phiếu nhập này nên không thể sửa thông tin một trong những mã phiếu được", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            hiendl();
        }
