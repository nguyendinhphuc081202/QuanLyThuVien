...
namespace Menu
{
    public partial class Sach : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sách này đang được cho mượn hoặc đang được nhập nên không thể sửa thông tin được !!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            hiendl();
        }
